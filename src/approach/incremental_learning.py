...
class Inc_Learning_Appr:
    ...
    def __init__(self, model, device, nepochs=100, lr=0.05, decay_mile_stone=[80,120], lr_decay=0.1, clipgrad=10000,
                 momentum=0, wd=0, multi_softmax=False, scroll_step=1, fix_bn=False,
    ...
    def train_loop(self, t, trn_loader, val_loader):
        ...
        for e in range(self.nepochs):
            ...
            # Valid
            clock3 = time.time()
            valid_loss, valid_acc, _ = self.eval(t, val_loader, t)
            clock4 = time.time()
    ...
    def train_epoch(self, t, trn_loader):
        ...
        for images, targets in trn_loader:
            ...
            total_loss = 0.0
            self.model.apply(lambda m: setattr(m, 'scroll', self.scroll_step * t)) # change the perception of channels to shuffle
